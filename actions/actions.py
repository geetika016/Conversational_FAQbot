...
#import sys
#sys.path.append('/network/home/kalantaa/.local/lib/python3.6/site-packages')
...
class ActionGetFAQAnswer(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if float(score) > 0.93:
            ...
            dispatcher.utter_message("Did that answer your question?")
        else:
            response = "Sorry"
            dispatcher.utter_message(response)
            dispatcher.utter_message("I am unable to answer this question for you. \nPlease reach out to a Super User. \nDo you want to continue?")
        return []
